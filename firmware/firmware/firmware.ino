...
#define LOOPTIME        100 
//#define base_radius   0.125
#define linear_coeff    255
#define angular_coeff   30
...
void handle_cmd(const geometry_msgs::Twist& cmd_msg) {
  ...
  if (z == 0) {     // go straight
    ...
    PWM_val1 = x * linear_coeff + z * angular_coeff;
    PWM_val2 = x * linear_coeff - z * angular_coeff;
  }
  ...
  */
  ...
  PWM_val1 = constrain(x * linear_coeff + z * angular_coeff, -255, 255);
  PWM_val2 = constrain(x * linear_coeff - z * angular_coeff, -255, 255);

  last_cmd_time = millis();
}

ros::NodeHandle nh;
ros::Subscriber<geometry_msgs::Twist> sub("cmd_vel_pid", handle_cmd);
